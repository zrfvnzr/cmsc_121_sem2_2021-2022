...
var n=i.n(s)
var o=i("HGxv")
var r=o["default"].scoped("models_DateGroup")
var a=i("3H9/")
class u extends n.a.Model{dueAt(){const t=this.get("due_at")
return t?a["a"].parse(t):null}unlockAt(){const t=this.get("unlock_at")
return t?a["a"].parse(t):null}lockAt(){const t=this.get("lock_at")
return t?a["a"].parse(t):null}now(){const t=this.get("now")
return t?a["a"].parse(t):new Date}alwaysAvailable(){return!this.unlockAt()&&!this.lockAt()}pending(){const t=this.unlockAt()
...
return t&&t<this.now()}toJSON(){return{dueFor:this.get("title"),dueAt:this.dueAt(),unlockAt:this.unlockAt(),lockAt:this.lockAt(),available:this.available(),pending:this.pending(),open:this.open(),closed:this.closed()}}}u.prototype.defaults={get title(){return r.t("everyone_else","Everyone else")},due_at:null,unlock_at:null,lock_at:null}},FdVj:function(t,e,i){"use strict"
var s=i("qJBq")
var n=i.n(s)
var o=i("HGxv")
...
var r=function(t,e){return function(){return t.apply(e,arguments)}},a=function(t,e){for(var i in e)u.call(e,i)&&(t[i]=e[i])
function s(){this.constructor=t}s.prototype=e.prototype
t.prototype=new s
t.__super__=e.prototype
...
var a=i("XE4h")
var u=i("HGxv")
var l=u["default"].scoped("assignmentOverride")
var h=i("4M30")
var p=function(t,e){return function(){return t.apply(e,arguments)}},c=function(t,e){for(var i in e)d.call(e,i)&&(t[i]=e[i])
function s(){this.constructor=t}s.prototype=e.prototype
t.prototype=new s
t.__super__=e.prototype
...
e.conditionalRelease=Object(h["b"])({noop_id:"1"},{name:function(){return l.t("Mastery Paths")}})
...
var d=i("GEFT")
var f=i("HGxv")
var g=f["default"].scoped("models_Assignment")
var _=i("tybv")
var m=i("3H9/")
var y=i("FdVj")
var T=i("cRz0")
...
const i=new URL(t)
const s=new URL(e)
return i.origin===s.origin}var D,v,S,w=function(t,e){return function(){return t.apply(e,arguments)}},x=function(t,e){for(var i in e)A.call(e,i)&&(t[i]=e[i])
function s(){this.constructor=t}s.prototype=e.prototype
t.prototype=new s
t.__super__=e.prototype
return t},A={}.hasOwnProperty
...
return y["a"].validate(t)?this.set("points_possible",y["a"].parse(t)):this.set("points_possible",t)}
...
t=this.externalToolData()
if(!t)return""
if(1===t.studentCount)return g.t("Student")
return g.t("Students")}
...
return"Assignment"}
i.prototype.objectTypeDisplayName=function(){if(this.isQuiz()||this.isQuizLTIAssignment()&&S())return g.t("Quiz")
...
i.prototype.defaultDates=function(){return new p["a"]({due_at:this.get("due_at"),unlock_at:this.get("unlock_at"),lock_at:this.get("lock_at")})}
...
e=this.get("all_dates")
i=new _["a"](t)
return e?r.a.some(e.models,(function(e){return i.isDateInGradingPeriod(e.dueAt(),t.id)})):i.isDateInGradingPeriod(m["a"].parse(this.dueAt()),t.id)}
...
i.prototype.disabledMessage=function(){return g.t("Can't unpublish %{name} if there are student submissions",{name:this.get("name")})}
...
i=new T["a"](t,5*t,(s=this,function(t){return s.fetch().always((function(){t()
if(!e())return i.stop()}))}))
var s
return i.start()}
...
//# sourceMappingURL=39-c-cedff3125a.js.map